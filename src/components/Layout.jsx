...
function AboutSection(props) {
  ...
  return (
    <section {...props}>
      ...
      >
        In this podcast James sits down and just chats, no scripts, no agenda.
        Sometimes we talk about technology and sometimes we talk about our
        favorite new purchase, the food we made, or a trip we took.
      </p>
      {!isExpanded && (
        <button
          type="button"
        ...
        <div className="relative z-10 mx-auto px-4 pb-4 pt-10 sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 lg:py-12 lg:px-8 xl:px-12">
          ...
          <div className="mt-10 text-center lg:mt-12 lg:text-left">
            <p className="text-xl font-bold text-slate-900">
              <a href="/">Developers Hangout</a>
            </p>
            <p className="mt-3 text-lg font-medium leading-8 text-slate-700">
              Conversations with developers about things that aren&apos;t always
              development
            </p>
          </div>
            ...
            >
              {[
                [
                  'Spotify',
                  SpotifyIcon,
                  'https://open.spotify.com/show/0hzoNDEoV6B7IQzOTr6XFv'
                ],
                [
                  'Apple Podcast',
                  ApplePodcastIcon,
                  'https://podcasts.apple.com/us/podcast/developers-hangout/id1572173062'
                ],
                [
                  'Overcast',
                  OvercastIcon,
                  'https://overcast.fm/itunes1572173062'
                ],
                [
                  'RSS Feed',
                  RSSIcon,
                  'https://feeds.zencastr.com/f/OijK_KWY.rss'
                ]
              ].map(([label, Icon, urlLink]) => (
